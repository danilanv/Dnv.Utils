...
namespace Dnv.Utils.Collections
{
    ...
    public class ObservableCollectionsLinker<TSourceItemType, TDestItemType> where TDestItemType: class
    {
        ObservableCollection<TSourceItemType> _sourceCollection;
