...
namespace Dnv.Utils.DummyLogging
{
    public class GuiLogger: ILogger, IDisposable
    {
        ...
        public GuiLogger(Dispatcher dispatcher, 
        ...
        public GuiLogger(Dispatcher dispatcher, ObservableCollection<LogMessageViewModel> items, 
        ...
        private void AddMessageToList(ObservableCollection<LogMessageViewModel> log, string message, LogMessageViewModel messageViewModel, string typeString)
        {
            ...
            _streamWriter.WriteLine(typeString + ": " + message);
            _streamWriter.Flush();
        }
